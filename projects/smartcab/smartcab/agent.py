...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # First dimension: light + traffic
        if inputs['light'] != 'green':
            if inputs['left'] == 'forward':
                state = 'Red_LF'
            elif inputs['right'] == 'forward':
                state = 'Red_RF'
    ...
    def get_maxQ(self, state):
        """ The get_max_Q function is called when the agent is asked to find the maximum Q-value of all actions based on the 'state' the smartcab is in. """
